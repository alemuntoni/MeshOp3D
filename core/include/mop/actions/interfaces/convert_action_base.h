...
#ifndef MOP_ACTIONS_INTERFACES_CONVERT_ACTION_BASE_H
#define MOP_ACTIONS_INTERFACES_CONVERT_ACTION_BASE_H
...
#endif // MOP_ACTIONS_INTERFACES_CONVERT_ACTION_BASE_H
