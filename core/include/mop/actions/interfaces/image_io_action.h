...
#ifndef MOP_CORE_ACTIONS_INTERFACES_IMAGE_IO_ACTION_H
#define MOP_CORE_ACTIONS_INTERFACES_IMAGE_IO_ACTION_H
...
#endif // MOP_CORE_ACTIONS_INTERFACES_IMAGE_IO_ACTION_H
