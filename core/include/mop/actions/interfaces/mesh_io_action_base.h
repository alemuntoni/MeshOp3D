...
#ifndef MOP_CORE_ACTIONS_INTERFACES_MESH_IO_ACTION_BASE_H
#define MOP_CORE_ACTIONS_INTERFACES_MESH_IO_ACTION_BASE_H
...
#endif // MOP_CORE_ACTIONS_INTERFACES_MESH_IO_ACTION_BASE_H
