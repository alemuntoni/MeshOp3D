...
#ifndef MOP_CORE_ACTIONS_ACTIONS_IMAGE_IO_BASE_IMAGE_IO_H
#define MOP_CORE_ACTIONS_ACTIONS_IMAGE_IO_BASE_IMAGE_IO_H
...
#endif // MOP_CORE_ACTIONS_ACTIONS_IMAGE_IO_BASE_IMAGE_IO_H
