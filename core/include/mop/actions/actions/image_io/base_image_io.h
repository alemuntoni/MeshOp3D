...
#ifndef MOP_ACTIONS_ACTIONS_IMAGE_IO_BASE_IMAGE_IO_H
#define MOP_ACTIONS_ACTIONS_IMAGE_IO_BASE_IMAGE_IO_H
...
#endif // MOP_ACTIONS_ACTIONS_IMAGE_IO_BASE_IMAGE_IO_H
