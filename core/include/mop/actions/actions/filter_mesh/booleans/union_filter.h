...
#ifndef MOP_CORE_ACTIONS_ACTIONS_FILTER_MESH_BOOLEANS_UNION_FILTER_H
#define MOP_CORE_ACTIONS_ACTIONS_FILTER_MESH_BOOLEANS_UNION_FILTER_H
...
#endif // MOP_CORE_ACTIONS_ACTIONS_FILTER_MESH_BOOLEANS_UNION_FILTER_H
