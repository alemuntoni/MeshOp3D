...
#ifndef MOP_CORE_ACTIONS_ACTIONS_CONVERT_POLY_EDGE_MESH_H
#define MOP_CORE_ACTIONS_ACTIONS_CONVERT_POLY_EDGE_MESH_H
...
#endif // MOP_CORE_ACTIONS_ACTIONS_CONVERT_POLY_EDGE_MESH_H
