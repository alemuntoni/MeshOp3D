...
#ifndef MOP_CORE_BASE_POLYMORPHIC_OBJECT_VECTOR_H
#define MOP_CORE_BASE_POLYMORPHIC_OBJECT_VECTOR_H
...
class PolymorphicObjectVector : protected vcl::PointerVector<std::shared_ptr<T>, N>
{
    using Base       = vcl::PointerVector<std::shared_ptr<T>, N>;
...
public:
    ...
    void set(Rng&& r) requires vcl::InputRange<Rng, T>
    {
...
#endif // MOP_CORE_BASE_POLYMORPHIC_OBJECT_VECTOR_H
