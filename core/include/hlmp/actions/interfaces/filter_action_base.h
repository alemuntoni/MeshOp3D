...
#ifndef HLMP_ACTIONS_INTERFACES_FILTER_ACTION_BASE_H
#define HLMP_ACTIONS_INTERFACES_FILTER_ACTION_BASE_H
...
#endif // HLMP_ACTIONS_INTERFACES_FILTER_ACTION_BASE_H
