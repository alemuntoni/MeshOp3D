...
#ifndef M3D_ACTIONS_ACTIONS_FILTER_MESH_CLEAN_REMOVE_UNREFERENCED_VERTICES_FILTER_H
#define M3D_ACTIONS_ACTIONS_FILTER_MESH_CLEAN_REMOVE_UNREFERENCED_VERTICES_FILTER_H
...
class RemoveUnreferencedVerticesFilter
    : public FilterActionBase<RemoveUnreferencedVerticesFilter>
{
public:
    std::string name() const final { return "Remove Unreferenced Vertices"; }

    std::string description() const final
    {
        return "Removes all vertices that are not referenced by any face or edge.";
    }
...
#endif // M3D_ACTIONS_ACTIONS_FILTER_MESH_CLEAN_REMOVE_UNREFERENCED_VERTICES_FILTER_H
