...
#ifndef M3D_ACTIONS_INTERFACES_MESH_IO_ACTION_BASE_H
#define M3D_ACTIONS_INTERFACES_MESH_IO_ACTION_BASE_H
...
#endif // M3D_ACTIONS_INTERFACES_MESH_IO_ACTION_BASE_H
