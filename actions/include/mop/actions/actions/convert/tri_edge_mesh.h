...
#ifndef MOP_ACTIONS_ACTIONS_ACTIONS_CONVERT_TRI_EDGE_MESH_H
#define MOP_ACTIONS_ACTIONS_ACTIONS_CONVERT_TRI_EDGE_MESH_H
...
#endif // MOP_ACTIONS_ACTIONS_ACTIONS_CONVERT_TRI_EDGE_MESH_H
