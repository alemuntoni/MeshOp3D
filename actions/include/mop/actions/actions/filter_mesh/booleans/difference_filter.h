...
#ifndef MOP_ACTIONS_ACTIONS_ACTIONS_FILTER_MESH_BOOLEANS_DIFFERENCE_FILTER_H
#define MOP_ACTIONS_ACTIONS_ACTIONS_FILTER_MESH_BOOLEANS_DIFFERENCE_FILTER_H
...
class DifferenceFilter : public FilterActionBase<DifferenceFilter>
{
public:
    std::string name() const final { return "Boolean Difference"; }

    std::string description() const final
    {
        return "Computes the boolean difference (First Mesh - Second Mesh) of two watertight meshes.";
    }
    ...
    {
        return {
            UintParameter("mesh_a", 1, "First Mesh (Minuend)", ""),
            UintParameter("mesh_b", 2, "Second Mesh (Subtrahend)", "")};
    }
        ...
        vcl::AbstractLogger& log = FilterAction::logger()) const
    {
        ...
        MeshType result = vcl::igl::meshBoolean(m1, m2, vcl::igl::MeshBoolean::DIFFERENCE);
...
#endif // MOP_ACTIONS_ACTIONS_ACTIONS_FILTER_MESH_BOOLEANS_DIFFERENCE_FILTER_H
