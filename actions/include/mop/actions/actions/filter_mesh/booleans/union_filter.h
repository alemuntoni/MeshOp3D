...
#ifndef MOP_ACTIONS_ACTIONS_ACTIONS_FILTER_MESH_BOOLEANS_UNION_FILTER_H
#define MOP_ACTIONS_ACTIONS_ACTIONS_FILTER_MESH_BOOLEANS_UNION_FILTER_H
...
class UnionFilter : public FilterActionBase<UnionFilter>
{
public:
    std::string name() const final { return "Boolean Union"; }

    std::string description() const final
    {
        return "Computes the boolean union of two watertight meshes.";
    }
        ...
        vcl::AbstractLogger& log = FilterAction::logger()) const
    {
        ...
        MeshType result = vcl::igl::meshBoolean(m1, m2, vcl::igl::MeshBoolean::UNION);
        result.name() = "Union";
...
#endif // MOP_ACTIONS_ACTIONS_ACTIONS_FILTER_MESH_BOOLEANS_UNION_FILTER_H
