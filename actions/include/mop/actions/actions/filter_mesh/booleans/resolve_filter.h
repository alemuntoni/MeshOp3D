...
#ifndef MOP_ACTIONS_ACTIONS_ACTIONS_FILTER_MESH_BOOLEANS_RESOLVE_FILTER_H
#define MOP_ACTIONS_ACTIONS_ACTIONS_FILTER_MESH_BOOLEANS_RESOLVE_FILTER_H
...
class ResolveFilter : public FilterActionBase<ResolveFilter>
{
public:
    std::string name() const final { return "Boolean Resolve"; }

    std::string description() const final
    {
        return "Resolves self-intersections and overlaps between two watertight meshes.";
    }
        ...
        vcl::AbstractLogger& log = FilterAction::logger()) const
    {
        ...
        MeshType result = vcl::igl::meshBoolean(m1, m2, vcl::igl::MeshBoolean::RESOLVE);
        result.name() = "Resolved Mesh";
...
#endif // MOP_ACTIONS_ACTIONS_ACTIONS_FILTER_MESH_BOOLEANS_RESOLVE_FILTER_H
