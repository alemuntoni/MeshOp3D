...
std::vector<std::shared_ptr<Action>> actionInstances()
{
    ...
    // Convert actions
    detail::fillActionInstances(vec, ConvertActionsList());

    // Filter actions
    detail::fillActionInstances(vec, FilterActionsList());

    // ImageIO actions
    detail::fillActionInstances(vec, ImageIOActionsList());

    // MeshIO actions
    detail::fillActionInstances(vec, MeshIOActionsList());
